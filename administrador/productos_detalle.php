...
<html>
	<head>
		...
		<link rel="stylesheet" href="../Estilos/Estilos_productos_detalles.css">
					...
					<?php if($row = $res->fetch_array()){
							...
							echo"<div id='info' class='tab txt'>";
								echo "<div id='dist'>";
									...
									echo"</div>";
									echo"<div id='info' class='tab txt'>";
										echo "<div class='borde color2 encabezado2 tab txttitle'>Codigo</div>";
										echo "<div class='borde color1 encabezado2'>$codigo</div>";
									echo"</div>";
								echo"</div>";
								echo "<div class='borde color2 encabezado tab txttitle'>Nombre</div>";
								echo "<div class='borde color1 encabezado'>$nombre</div>";
								echo "<div class='borde color2 encabezado tab txttitle'>Descripcion</div>";
								echo "<div class='borde color1 encabezado'>$descripcion</div>";
								echo "<div id='dist'>";
									echo"<div id='info' class='tab txt'>";
										echo "<div class='borde color2 encabezado2 tab txttitle'>Stock</div>";
										echo "<div class='borde color1 encabezado2'>$stock</div>";
									echo"</div>";
									echo"<div id='info' class='tab txt'>";
										echo "<div class='borde color2 encabezado2 tab txttitle'>Costo</div>";
										echo "<div class='borde color1 encabezado2'>$costo $</div>";
									echo"</div>";
								echo"</div>";
							echo"</div>";
							echo"<div id='imagen' class='tab txt'>";
								echo"<div class='borde1 img'><img class='img1' src='../productos/$archivo1'/></div>";
